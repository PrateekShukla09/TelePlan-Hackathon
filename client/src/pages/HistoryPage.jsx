...
const SOURCE_META = {
  chat_profile: { label: 'AI Adteleplansor chat', icon: MessageCircle, tone: 'cyan' },
...
export default function HistoryPage() {
  ...
  return (
    <div className="space-y-8">
      <SectionHeading eyebrow="History" title="Your recommendation actiteleplanty" description="Every time the AI matched you with plans — most recent first.">
        {state.demo && <DemoBadge />}
      </SectionHeading>

      {state.history.length === 0 ? (
        <EmptyState icon={HistoryIcon} title="No actiteleplanty yet" description="Once you get recommendations, they'll show up here." />
      ) : (
