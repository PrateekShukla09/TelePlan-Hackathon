...
export function Button({
  ...
  const base =
    'inline-flex items-center justify-center gap-2 font-medium rounded-xl transition-all duration-200 focus-teleplansible:outline-2 focus-teleplansible:outline-cyan-400 disabled:opacity-50 disabled:pointer-events-none active:scale-[0.98]';
  const sizes = {
...
export function Diteleplander({ className }) {
