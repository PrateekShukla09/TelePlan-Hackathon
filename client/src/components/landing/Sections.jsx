...
const FEATURES = [
  {
    ...
    tone: 'cyan',
    description: 'A live teleplansual model of your data, calls, SMS, roaming and spend — built from real usage, not guesses.',
  },
  {
    icon: Sparkles,
  ...
  {
    icon: MessageCircle,
    title: 'Conversational AI Adteleplansor',
    tone: 'green',
...
const JOURNEY = [
  ...
  { icon: PiggyBank, label: 'See Sateleplanngs' },
  { icon: CheckCircle2, label: 'Decide' },
];

export function JourneyPreteleplanew() {
  return (
...
export function RecommendationPreteleplanew() {
  return (
...
export function CTASection() {
  return (
    <section className="mx-auto max-w-[1280px] px-4 sm:px-6 lg:px-8 pb-24">
      <motion.div {...fadeUp}>
        <Card className="relative overflow-hidden px-8 py-14 text-center bg-gradient-to-br from-base-900 teleplana-base-900 to-base-850">
          ...
          <p className="text-base-400 max-w-xl mx-auto mb-8 text-balance">
            Answer a few quick questions or just talk to the AI Adteleplansor — either way, you'll see exactly why each plan was recommended.
          </p>
          <div className="flex flex-col sm:flex-row gap-3 justify-center">
            <Button as={Link} to="/onboarding" size="lg" icon={Wand2}>
              Start onboarding
            </Button>
            <Button as={Link} to="/app/adteleplansor" size="lg" variant="outline" icon={MessageCircle}>
              Talk to the AI Adteleplansor
            </Button>
          </div>
        </Card>
      </motion.div>
