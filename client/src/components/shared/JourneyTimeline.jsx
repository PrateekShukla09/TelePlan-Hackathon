import { UserCircle2, Actiteleplanty, Fingerprint, GitCompareArrows, Sparkles, MessageSquareText, Check } from 'lucide-react';
import { motion } from 'framer-motion';

const STAGES = [
  { key: 'profile', label: 'Profile', icon: UserCircle2 },
  { key: 'usage', label: 'Usage Analysis', icon: Actiteleplanty },
