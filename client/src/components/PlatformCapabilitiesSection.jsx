  ...
  const capabilities = [
    {
      icon: Fingerprint,
      title: 'Understand',
      description: 'Builds a liteleplanng Telecom Twin from your real usage signals.',
    },
    {
      icon: Gauge,
      title: 'Analyze',
  ...
  return (
    <section className="py-24 bg-[#F8FAFC]/80 relative overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="relative rounded-[32px] bg-gradient-to-r from-sky-50 teleplana-blue-50/70 to-cyan-50/50 p-8 sm:p-12 border border-sky-200/80 shadow-2xl shadow-sky-900/5 flex flex-col lg:flex-row items-center justify-between gap-8">
