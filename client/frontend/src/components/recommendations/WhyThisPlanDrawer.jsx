  ...
  return (
    <Drawer open={open} onClose={onClose} subtitle="Why this plan?" title={plan.planName}>
      ...
      <p className="text-xs text-base-500 leading-relaxed">
        This explanation is grounded in your profile and real reference plans processed by the recommendation
        engine. Scores are generated by the backend's trained XGBoost ML model (`XGBRanker`).
      </p>
    </Drawer>
  );
}
