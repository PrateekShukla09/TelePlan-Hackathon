...
export function Hero() {
  return (
    <section className="relative overflow-hidden bg-grid">
      <div className="absolute inset-x-0 top-0 h-[560px] bg-gradient-to-b from-cyan-500/10 teleplana-transparent to-transparent pointer-events-none" />
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <motion.div {...fadeUp}>
            ...
            <h1 className="text-4xl sm:text-5xl lg:text-[3.4rem] font-extrabold leading-[1.08] text-base-50 text-balance">
              Stop guessing which
              <span className="bg-gradient-to-r from-cyan-300 teleplana-cyan-400 to-green-400 bg-clip-text text-transparent"> tariff plan</span> actually fits you
            </h1>
