          ...
          <div className="lg:col-span-7 space-y-7">
            ...
            <div className="space-y-1">
              <h1 className={`text-5xl sm:text-6xl xl:text-7xl font-extrabold tracking-tight leading-[1.08] ${
                ...
                Your Plan Should <br />
                <span className="bg-gradient-to-r from-[#0066FF] teleplana-[#0099FF] to-[#00D8F6] bg-clip-text text-transparent">Understand You.</span>
              </h1>
            </div>
            ...
            <p className={`text-base sm:text-lg font-normal leading-relaxed max-w-xl ${
              ...
              SmartFit analyzes your Internet, 5G and calling behateleplanor to recommend the tariff plan that fits your lifestyle — today and tomorrow.
            </p>
