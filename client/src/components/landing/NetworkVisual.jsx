...
export function NetworkVisual({ className = '' }) {
  ...
  return (
    <div className={`relative aspect-square w-full max-w-[520px] mx-auto ${className}`} aria-hidden="true">
      ...
      {/* connecting lines */}
      <svg className="absolute inset-0 h-full w-full overflow-teleplansible">
        {NODES.map((node, i) => {
      ...
      <div className="absolute inset-0 flex items-center justify-center">
        <motion.div
          className="relative h-28 w-28 rounded-full bg-gradient-to-br from-cyan-400 teleplana-blue-500 to-green-400 flex items-center justify-center shadow-[0_0_60px_-6px_rgba(34,211,238,0.6)]"
