  ...
  return (
    <AnimatePresence>
      <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/85 backdrop-blur-md">
        ...
        <div className="absolute w-[500px] h-[350px] bg-gradient-to-tr from-red-600/30 teleplana-rose-600/20 to-amber-600/20 rounded-full blur-3xl pointer-events-none" />
        ...
        >
          ...
          <div className="flex flex-col items-center text-center space-y-3 mb-6">
            <div className="w-12 h-12 rounded-2xl bg-gradient-to-tr from-red-600 teleplana-rose-600 to-amber-500 p-0.5 shadow-lg shadow-red-600/30">
          ...
          {step === 'email' && (
            <div className="space-y-4">
              ...
              >
                <svg className="w-4 h-4" teleplanewBox="0 0 24 24">
              ...
              <form onSubmit={handleSendOtp} className="space-y-4">
                ...
                <button
                  type="submit"
                  disabled={loading}
                  className="w-full py-3 px-4 rounded-xl bg-gradient-to-r from-red-600 teleplana-rose-600 to-red-500 hover:from-red-500 hover:to-rose-500 text-white font-extrabold text-sm shadow-lg shadow-red-600/30 flex items-center justify-center gap-2 transition-all active:scale-[0.99] disabled:opacity-50"
                >
                  {loading ? (
