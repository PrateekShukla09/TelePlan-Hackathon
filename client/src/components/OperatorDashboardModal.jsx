      ...
      <div className="bg-white rounded-3xl max-w-4xl w-full max-h-[90vh] overflow-y-auto shadow-2xl border border-slate-100 p-6 sm:p-8 relative">
        ...
        <div className="flex items-center space-x-3 mb-6">
          ...
          <div>
            ...
            <p className="text-xs text-slate-500 font-medium">
              Live market ranking, tariff pricing comparison & usage trends across TelePlan, TelePlan, TelePlan, TelePlan
            </p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 mb-8">
          <div className="p-4 rounded-2xl bg-slate-50 border border-slate-100">
            ...
            <p className="text-xl font-extrabold text-slate-900">TelePlan (₹249)</p>
          </div>
          ...
          <div className="p-4 rounded-2xl bg-slate-50 border border-slate-100">
            ...
            <p className="text-xl font-extrabold text-slate-900">TelePlan (96%)</p>
          </div>
